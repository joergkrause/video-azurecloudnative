...
namespace Heise.Workshop.Course.DataReceiver.Notifications
{
  ...
  /// </summary>
  public static class BeltSpeedValue
  {

    [FunctionName(nameof(BeltSpeedValue))]
    public static async Task Run(
        [CosmosDBTrigger(
          databaseName: "%CosmosDbWarmStorage%",
          collectionName: "BeltSpeed",
    ...
    {
      log.LogInformation($"{nameof(BeltSpeedValue)}: Received cosmos trigger message");
